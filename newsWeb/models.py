...
class push(models.Model):
    ...
    time = models.CharField(max_length=200, default= '')
    pusername_like_movies = models.CharField(max_length=200, default= '')
    like = models.FloatField(default= 0)
    like_movies_title = models.FloatField(default= 0)
    like_movies = models.FloatField(default= 0)
    like_age = models.FloatField(default= 0)
class message(models.Model):
    username = models.CharField(max_length=200)
    pusername = models.CharField(max_length=200)
    time = models.CharField(max_length=200, default= '')
    message = models.CharField(max_length=200, default= '')
    isRead = models.BooleanField(max_length=200, default=False)
